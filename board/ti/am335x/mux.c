...
static struct module_pin_mux gpio2_8_pin_mux[] = {
	{OFFSET(lcd_data2), (MODE(7) | PULLUDEN | PULLUP_EN | RXACTIVE)},	/* GPIO2_8 */
	{-1},
};

static struct module_pin_mux gpio3_17_pin_mux[] = {
	{OFFSET(mcasp0_ahclkr), (MODE(7) | PULLUDEN)},	/* GPIO3_17 */
	{-1},
};
...
static struct module_pin_mux chipsee_led_pin_mux[] = {
	{OFFSET(xdma_event_intr0), (MODE(7) | PULLUDEN)},	/* LED0 */
	{OFFSET(xdma_event_intr1), (MODE(7) | PULLUDEN)},	/* LED1 */
	{-1},
};
/*
...
void enable_gpio2_8_pin_mux(void)
{
	configure_module_pin_mux(gpio2_8_pin_mux);
}

void enable_gpio3_17_pin_mux(void)
{
	configure_module_pin_mux(gpio3_17_pin_mux);
}

void enable_gpio1_18_pin_mux(void)
{
	configure_module_pin_mux(gpio1_18_pin_mux);
}

void enable_chipsee_led_pin_mux(void)
{
	configure_module_pin_mux(chipsee_led_pin_mux);
}

void enable_eth_pin_mux(void)
{
